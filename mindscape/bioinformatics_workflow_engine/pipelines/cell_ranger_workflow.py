...
class CellRangerWorkflow(BaseWorkflow):
    ...
    def __init__(self, config_path, logger=None):
        ...
        # ⚠️ WARNING: This CSV file is manually curated and must exist at the specified location.
        # It must follow 10x Genomics' `multi` CSV format and include valid sample, fastq, and barcode information.
        # This file is NOT generated by the workflow — ensure is in this location before running the workflow.
