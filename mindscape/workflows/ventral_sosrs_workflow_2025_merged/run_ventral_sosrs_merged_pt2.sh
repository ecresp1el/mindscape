...
#SBATCH --job-name=ventral_sosrs_integration
...
SCRIPT_PATH="/home/oltij/githubprojectfolder/mindscape/mindscape/workflows/ventral_sosrs_workflow_2025_merged/mindscape_integrate_samples.R"
