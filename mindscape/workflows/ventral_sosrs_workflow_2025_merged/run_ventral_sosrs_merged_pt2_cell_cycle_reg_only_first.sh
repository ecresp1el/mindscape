...
#SBATCH --job-name=ventral_sosrs_integration_cell_cycle_reg_only_first
...
SCRIPT_PATH="/home/oltij/githubprojectfolder/mindscape/mindscape/workflows/ventral_sosrs_workflow_2025_merged/mindscape_integrate_samples_cell_cycle_reg_only_first.R"
...
export MINDSCAPE_OUTPUT_DIR="/nfs/turbo/umms-parent/Manny_test/ventral_sosrs_output_integrated_analysis_cell_cycle_reg_only_first"
