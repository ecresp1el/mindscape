...
#    /nfs/turbo/umms-parent/Manny_test/MindScape/mindscape/workflows/ventral_sosrs_workflow_2025/mindscape_process_sample_normalized.R
#
...
SCRIPT_DIR="/home/oltij/githubprojectfolder/mindscape/mindscape/workflows/ventral_sosrs_workflow_2025_merged"
