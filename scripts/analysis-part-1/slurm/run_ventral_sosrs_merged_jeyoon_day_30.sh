...
#    /nfs/turbo/umms-parent/Manny_test/MindScape/mindscape/workflows/ventral_sosrs_workflow_2025/mindscape_process_sample_normalized_jeyoon_day_30.R
#
# 2. Ensure Cell Ranger outputs exist at:
#    /nfs/turbo/umms-parent/Manny_test/9583-MW-reanalysis/outs/per_sample_outs/<sample_id>/count/
#
# 3. Submit the job using:
#    sbatch run_ventral_sosrs_merged_jeyoon_day_30.sh
#
# Each task will:
...
#
#   - MINDSCAPE_SINGLE_SAMPLE: ID of the sample to process (e.g., "9853-MW-1")
...
#SBATCH --array=0-8                                      # Number of samples (0-indexed)
...
SCRIPT_PATH="$SCRIPT_DIR/mindscape_process_sample_normalized_jeyoon_day_30.R"

# Define a structured output location outside the Git repo, named after the job
OUTPUT_DIR="$BASE_DIR/ventral_sosrs_output_only_normalized_jeyoon_day_30"

# Log output folder now set to Turbo output location for consistency
LOG_DIR="$OUTPUT_DIR/logs_for_normalization_jeyoon_day_30"
...
SAMPLE_LIST=(9853-MW-1 9853-MW-2 9853-MW-3 9853-MW-4 9853-MW-5 9853-MW-6 9853-MW-7 9853-MW-8 9853-MW-9)
