# mindscape_process_sample_normalized_jeyoon_day_30.R
#
# -------------------------------------------------------------------------------
# PURPOSE:
...
# Load sample matrix
# ------------------------------------------------------------------------------
per_sample_base <- "/nfs/turbo/umms-parent/Manny_test/9583-MW-reanalysis/outs/per_sample_outs"
...
# ------------------------------------------------------------------------------
# Minimal Seurat pipeline for normalization and individual variable features
# ------------------------------------------------------------------------------
...
seurat_obj <- subset(seurat_obj, subset = nFeature_RNA > 1500 & nFeature_RNA < 9000 & nCount_RNA < 30000 & percent.mt < 5)
