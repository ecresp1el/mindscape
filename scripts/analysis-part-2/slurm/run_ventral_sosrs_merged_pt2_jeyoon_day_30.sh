...
#SBATCH --job-name=ventral_sosrs_integration_cell_cycle_reg_jeyoon_day_30
...
export MINDSCAPE_INPUT_DIR="$BASE_DIR/ventral_sosrs_output_only_normalized_jeyoon_day_30"
export MINDSCAPE_OUTPUT_DIR="$BASE_DIR/ventral_sosrs_output_integrated_analysis_cell_cycle_reg_jeyoon_day_30"
